...
/*
 * The AVL tree and other self-balancing search trees like Red Black
 * are useful to get all basic operations done in O(log n) time.
 ...
 * deletions are less frequent and search is the more frequent operation, 
 * then AVL tree should be preferred over Red Black Tree.
 */
public class RedBlackTree {
	
	// Red Black Tree - a self balancing BinarySearchTree
	// like AVL tree
